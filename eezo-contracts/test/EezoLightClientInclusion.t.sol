...
contract EezoLightClientInclusionTest is Test {
    ...
    // deterministic test chain id (lowercase label as you prefer)
    ...
    function test_MerkleInclusion_4leaf_tree() public {
        ...
        EezoLightClient.HeaderV2 memory h = EezoLightClient.HeaderV2({
            ...
            batchLen: 4,
            // T33.6: new 7th field (chain binding)
            chainId20: CHAIN,
            // T34.2: new 8th field (suite binding). default active = 1 (ml-dsa-44)
            suiteId: 1
        });
        lc.__setHeader(h);
