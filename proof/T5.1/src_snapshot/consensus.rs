...
use crate::config::BatchVerifyCfg; // Import BatchVerifyCfg
...
pub fn validate_consensus_batch(
    ...
    cfg: &BatchVerifyCfg, // Change from VerifyConfig to BatchVerifyCfg
    ...
    let flags: BitVec = {
        #[cfg(feature = "pq44-runtime")]
        {
            if cfg.parallel { // Use cfg.parallel instead of cfg.parallel_verify
...
pub struct Consensus {
    ...
    pub verify_cfg: BatchVerifyCfg, // Change from VerifyConfig to BatchVerifyCfg
}
