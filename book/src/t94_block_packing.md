...
## Verifying T94 Is Active

When T94 perf mode is enabled, you should see:
...
```
T94.0: early tick #1 (mempool_len=1500, threshold=1000, elapsed=25ms)
T94.0: early tick #11 (mempool_len=1200, threshold=1000, elapsed=15ms)
```
